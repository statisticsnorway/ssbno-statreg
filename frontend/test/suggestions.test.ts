...
describe('date helpers', () => {
  ...
  describe('isWeekend()', () => {
    ...
    test('does not identify ordinary working days as weekend', () => {
  ...
  describe('isPublicHoliday()', () => {
    ...
    test('does not identify ordinary working days as holiday', () => {
      const date = new Date('2024-06-03')
...
describe('getNextRelease()', () => {
  ...
  test('suggests the next weekly release', () => {
    ...
    expect(getNextRelease(input1)).toEqual(expected)
    expect(getNextRelease(input2)).toEqual(expected)
  })
  ...
  test('suggests the next monthly release', () => {
    ...
    expect(getNextRelease(input)).toEqual(expected)
  })
