...
export default function CreateStatistic() {
  ...
  useEffect(() => {
    ...
    async function initializeCreateStatistic() {
      ...
      const statisticExists = shortnameExists.statistic_name
          ...
          {!isRouteValidated && (
            <>
              <Alert data-color='success'>
                ...
                <Paragraph>
                  Fyll ut resten av informasjonen. Alle obligatoriske felter må fylles ut før du kan opprette den
                  endelige statistikken.
                </Paragraph>
              </Alert>
                  ...
                  <div className='create-statistic-form-status-label'>
                    ...
                    <Popover.TriggerContext>
                      ...
                      <Popover placement='right' data-color='info'>
                        <ul>
                          <li>
                            Statistikker som har blitt opprettet med status «Aktiv», kan ikke bli gjort om til
                            «Kommende» igjen.
                          </li>
                          <li>
                  ...
                  <div className='created-variants-container'>
                    {createdVariants.map((variant, index) => (
                      <Card
                        key={[
                          'created-variant',
                          variant.frequency?.code ?? index,
                          variant.revision?.code ?? index,
                        ].join('-')}
                        variant='tinted'
                      >
                        <Card.Block>
