...
const mockedReleasesResult = [
  {
    ...
    measuring_period: { title: 'august 2024', title_en: 'August 2024' },
    frequency: {
      name: 'Måned',
      code: 'M',
    },
    revision: { code: 'I', name: 'Ingen' },
    statistic: {
      id: 1,
      shortname: 'KPI',
      name: 'Konsumprisindeks',
  ...
  },
  {
    ...
    measuring_period: { title: '2024', title_en: '2024' },
    frequency: {
      name: 'År',
      code: 'Y',
    },
    revision: { code: 'E', name: 'Endelige' },
    statistic: {
      id: 2,
      shortname: 'NR',
      name: 'Nasjonalregnskap',
  ...
  },
  {
    ...
    measuring_period: { title: '1. halvår 2026', title_en: 'first half of 2026' },
    frequency: {
      name: 'Halvår',
      code: 'H',
    },
    revision: { code: 'F', name: 'Foreløpige' },
    statistic: {
      id: 3,
      shortname: 'laks',
      name: 'Eksport av laks',
